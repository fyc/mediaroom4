...
public abstract class AbstractDeviceDialog extends DialogFragment implements DeviceStateNotifier {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(0x40000000));
        return dialog;
    }
