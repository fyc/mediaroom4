 ...
 *
 */
public class ExamRoomQueryControl extends BaseTextControl<ExamRoomQueryControlProperty> implements View.OnClickListener  {
    public ExamRoomQueryControl(Context context) {
        super(context);
    }

    public ExamRoomQueryControl(Context context, ViewGroup.MarginLayoutParams layoutParams) {
        super(context, layoutParams);
    }

    public ExamRoomQueryControl(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ExamRoomQueryControl(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    public void setProperty(ExamRoomQueryControlProperty property) {
    ...
    public void onClick(View v) {
        EventBus.getDefault().post(new ClickEvent(ClickEventType.QUERY_EXAM));
    }
}
