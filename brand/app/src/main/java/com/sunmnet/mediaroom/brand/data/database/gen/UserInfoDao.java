...
public class UserInfoDao extends AbstractDao<UserInfo, String> {
    ...
    public static class Properties {
        ...
        public final static Property Modify = new Property(4, Long.class, "modify", false, "MODIFY");
    ...
    protected final void bindValues(DatabaseStatement stmt, UserInfo entity) {
        ...
        Long modify = entity.getModify();
        if (modify != null) {
            stmt.bindLong(5, modify);
        }
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4), // modify
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setModify(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
