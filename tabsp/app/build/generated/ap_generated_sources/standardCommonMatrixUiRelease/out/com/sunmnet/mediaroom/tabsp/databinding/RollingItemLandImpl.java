...
public class RollingItemLandImpl extends RollingItem  {
    ...
    public RollingItemLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 1, sIncludes, sViewsWithIds));
    }
    private RollingItemLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.rollingText, itemGetName);
        }
    }
