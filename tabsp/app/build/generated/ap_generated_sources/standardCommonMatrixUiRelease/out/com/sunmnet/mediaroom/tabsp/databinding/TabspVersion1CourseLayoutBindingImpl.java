...
public class TabspVersion1CourseLayoutBindingImpl extends TabspVersion1CourseLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.iv_class_on_logo, 7);
        sViewsWithIds.put(R.id.tv_class_on_text, 8);
        sViewsWithIds.put(R.id.classon_onekey, 9);
        sViewsWithIds.put(R.id.iv_class_over_logo, 10);
        sViewsWithIds.put(R.id.tv_class_over_text, 11);
        sViewsWithIds.put(R.id.classover_onekey, 12);
    }
    // views
    @NonNull
    ...
    public TabspVersion1CourseLayoutBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private TabspVersion1CourseLayoutBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
