...
public class V3MatrixBindingImpl extends V3MatrixBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.matrixview3, 2);
    }
    // views
    @NonNull
    ...
    public V3MatrixBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private V3MatrixBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.GridView) bindings[1]
            , (com.sunmnet.mediaroom.matrix.MatrixView) bindings[2]
            );
        this.matrix3InputGrid.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.matrix3InputGrid.setAdapter(inputAdapter);
        }
    }
