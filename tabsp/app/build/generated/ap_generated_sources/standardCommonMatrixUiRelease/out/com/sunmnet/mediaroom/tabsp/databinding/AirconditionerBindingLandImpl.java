...
public class AirconditionerBindingLandImpl extends AirconditionerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.airconditioner_minus, 7);
        sViewsWithIds.put(R.id.airconditioner_plus, 8);
    }
    // views
    @NonNull
    ...
    public AirconditionerBindingLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private AirconditionerBindingLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
