...
public class InteracitveControllerLandImpl extends InteracitveController  {
    ...
    public InteracitveControllerLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private InteracitveControllerLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.ListView) bindings[1]
            );
        this.displayListview.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.displayListview.setAdapter(adapter);
        }
    }
