...
public class LectureBindingLandImpl extends LectureBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tagName, 2);
    }
    // views
    @NonNull
    ...
    public LectureBindingLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private LectureBindingLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.widget.GridView) bindings[1]
            , (android.widget.TextView) bindings[2]
            );
        this.lectureGrid.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.lectureGrid.setAdapter(adapter);
        }
    }
