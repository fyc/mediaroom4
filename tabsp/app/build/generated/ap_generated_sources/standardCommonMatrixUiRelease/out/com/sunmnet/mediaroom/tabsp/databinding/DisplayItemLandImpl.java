...
public class DisplayItemLandImpl extends DisplayItem  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.controll_name, 1);
        sViewsWithIds.put(R.id.controll_processing, 2);
        sViewsWithIds.put(R.id.controll_switcher, 3);
    }
    // views
    @NonNull
    ...
    public DisplayItemLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private DisplayItemLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
