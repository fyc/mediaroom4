...
public class DeviceInfoBindingLandImpl extends DeviceInfoBinding  {
    ...
    public DeviceInfoBindingLandImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private DeviceInfoBindingLandImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (android.widget.ProgressBar) bindings[4]
            , (android.widget.FrameLayout) bindings[2]
            , (android.widget.ImageView) bindings[3]
            , (com.sunmnet.mediaroom.tabsp.ui.widget.MarqueTextView) bindings[1]
            );
