...
public class InteractiveBindingImpl extends InteractiveBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.interactive_options_two, 9);
        sViewsWithIds.put(R.id.volumn_plus_btn, 10);
        sViewsWithIds.put(R.id.volumn_minus_btn, 11);
    }
    // views
    @NonNull
    ...
    public InteractiveBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private InteractiveBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
