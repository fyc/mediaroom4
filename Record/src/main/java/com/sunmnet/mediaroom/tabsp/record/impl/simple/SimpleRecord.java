...
public class SimpleRecord extends AbstractRecord implements SimpleRecordConnectListener {

    public SimpleRecord(RecordEntity entity) {
        super(entity);
        init(entity.getHost(), entity.getPort(), entity.getUserName(), entity.getPassword());
    }

    SimpleRecordWebSocket webSocket;
    String user, pwd;
    protected boolean isRecording = false;
    String url;

    private void init(String host, String port, String admin, String pwd) {
        webSocket = new SimpleRecordWebSocket(URI.create("ws://" + host + ":" + port), this);
    ...
    public void onConnected() {
        if (presentation == null) {
            presentation = new SimpleRecordPresentation();
    ...
    public void onException(Exception exception) {
        if (presentation != null) {
            presentation.onException(exception);
        }
    }
