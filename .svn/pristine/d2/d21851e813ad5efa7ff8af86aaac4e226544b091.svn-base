...
public class VerifySign {
    ...
    public VerifySign(Context context, File file) {
        this.context = context;
        this.cer = getCertificateSHA1Fingerprint();
        this.realCer = getCertificateSHA1FingerprintByFile(file.getAbsolutePath());
    }
    public VerifySign(Context context, String realCer) {
        this.context = context;
    ...
    public String getCertificateSHA1FingerprintByFile(String apkPath){
        PackageManager pm = context.getPackageManager();
        PackageInfo info = pm.getPackageArchiveInfo(apkPath,PackageManager.GET_SIGNATURES);
        return getCertificationSHA1ByPackageInfo(info);
    }
    ...
    public String getCertificateSHA1Fingerprint() {
        ...
        try {
            ...
            return getCertificationSHA1ByPackageInfo(packageInfo);
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
        }
        return null;
    }
    public String getCertificationSHA1ByPackageInfo(PackageInfo packageInfo){
