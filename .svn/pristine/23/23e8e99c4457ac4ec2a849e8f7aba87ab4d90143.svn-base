...
public class ExamTimeToStartToEndControlProperty extends TextStyleControlProperty<PrefixSuffixTextControlAttr> {

    @Override
    public PrefixSuffixTextControlAttr getAttr() {
