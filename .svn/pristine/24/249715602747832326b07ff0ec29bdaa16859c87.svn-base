...
public interface HCNetSDKByJNA extends Library {
    public static HCNetSDKByJNA INSTANCE = Native.loadLibrary("hcnetsdk",
            HCNetSDKByJNA.class);

    public static final int NET_DVR_IP_TEST = 3391;
    ...
    public static final int NET_DVR_GET_BACKGROUND_PIC_CFG = 6429;
    public static final int NET_DVR_GET_BACKGROUND_PIC_INFO = 6430;
    ...
    public static final int NET_DVR_GET_RECORD_STATUS = 6435;
    ...
    public static final int NET_DVR_MANUAL_CURRICULUM_CONTROL = 6436;
    public static final int NET_DVR_MANUAL_CURRICULUM_CONTROL_STATUS = 6435;
    ...
    public static class NET_DVR_PREVIEWINFO extends Structure {
        ...
        public byte bBlocked;
        public byte bPassbackRecord;
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"lChannel", "dwStreamType", "dwLinkMode"
                    , "bBlocked", "bPassbackRecord", "byPreviewMode"
                    , "byStreamID", "byProtoType", "byRes1", "byVideoCodingType"
                    , "dwDisplayBufNum", "byRes"});
        }
    }

    public static class INTER_PREVIEWINFO extends Structure {
        public int lChannel;
        public int dwStreamType;
        public int dwLinkMode;
        public int bBlocked;
        ...
        public byte byPreviewMode;
        public byte byProtoType;
        //public Surface hPlayWnd;

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"lChannel", "dwStreamType", "dwLinkMode",
                    "bBlocked", "bPassbackRecord", "byPreviewMode", "byProtoType"});
        }
    }
    ...
    public static class NET_DVR_STD_CONTROL extends Structure {
        public Pointer lpCondBuffer;
        public int dwCondSize;
        public Pointer lpStatusBuffer;
        public int dwStatusSize;
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("wStartMirrorChanNo", "byMirrorChanNum", "sSerialNumber", "byAlarmInPortNum", "byAlarmOutPortNum",
                    "byDiskNum", "byStartDChan", "byDVRType", "byChanNum", "byStartChan", "byAudioChanNum", "byIPChanNum", "byRes1");
        }
    }
    ...
    public static class NET_DVR_GETWORKSTATE_COND extends Structure {
        ...
        public byte[] byRes1 = new byte[2];
        public int[] dwFindHardStatus = new int[MAX_DISKNUM_V30];
        public int[] dwFindChanNo = new int[MAX_CHANNUM_V40];
        public byte[] byRes = new byte[64];

        @Override
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("dwSize", "byFindHardByCond", "byFindChanByCond", "byRes1", "dwFindHardStatus", "dwFindChanNo", "byRes");
        }
    }
    ...
    public static class NET_DVR_WORKSTATE_V40 extends Structure {
        ...
        public int[] dwHasAlarmInStatic = new int[MAX_ALARMIN_V40];
        public int[] dwHasAlarmOutStatic = new int[MAX_ALARMOUT_V40];
        ...
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("dwSize", "dwDeviceStatic", "struHardDiskStatic", "struChanStatic", "dwHasAlarmInStatic", "dwHasAlarmOutStatic", "dwLocalDisplay", "byAudioInChanStatus",
                    "byRes1", "fHumidity", "fTemperature", "byRes");
        }
    }
    ...
    public static class NET_DVR_CHANNELSTATE_V30 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            // TODO Auto-generated method stub
            return Arrays.asList("byRecordStatic", "bySignalStatic", "byHardwareStatic", "byRes1", "dwBitRate", "dwLinkNum", "struClientIP", "dwIPLinkNum", "byExceedMaxLink",
                    "byRes", "dwAllBitRate", "dwChannelNo");
        }
    }


    public static class NET_DVR_IDENTIFICATION_PARAM extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("sUserName", "sPassword", "byRes1");
        }
    }

    public static class NET_DVR_MOUNT_PARAM_UNION extends Union {
        public byte[] uLen = new byte[52];
        NET_DVR_IDENTIFICATION_PARAM struIdentificationParam = new NET_DVR_IDENTIFICATION_PARAM();
    }

    public static class NET_DVR_NAS_MOUNT_PARAM extends Structure {
        public byte byMountType;
        public byte[] byRes = new byte[3];
        public NET_DVR_MOUNT_PARAM_UNION uMountParam = new NET_DVR_MOUNT_PARAM_UNION();

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("byMountType", "byRes", "uMountParam");
        }
    }

    public static class NET_DVR_MOUNTMETHOD_PARAM_UNION extends Union {
        public byte[] uLen = new byte[56];
        public NET_DVR_NAS_MOUNT_PARAM struNasMountParam = new NET_DVR_NAS_MOUNT_PARAM();
    }

    public static class NET_DVR_SINGLE_NET_DISK_INFO_V40 extends Structure {
        public byte byNetDiskType;
        public byte[] byRes1 = new byte[3];
        public byte[] sDirectory = new byte[128];
        public byte[] byDevAddr = new byte[64];
        public int wPort;
        public byte[] byRes2 = new byte[2];
        public NET_DVR_MOUNTMETHOD_PARAM_UNION uMountMethodParam = new NET_DVR_MOUNTMETHOD_PARAM_UNION();
        public byte[] byRes4 = new byte[80];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("byNetDiskType", "byRes1", "sDirectory", "byDevAddr", "wPort", "byRes2", "uMountMethodParam", "byRes4");
        }
    }

    public static class Domain extends Structure {
    ...
    public static class AddrIP extends Structure {
        public NET_DVR_IPADDR struIp = new NET_DVR_IPADDR();
    ...
    public static class Server extends Union {
        public byte[] byRes = new byte[144];
        public Domain struDomain = new Domain();
        public AddrIP struAddrIP = new AddrIP();
    }

    public static class NET_DVR_FTP_SERVER_TEST_PARA extends Structure {
        public int dwSize;
        public byte byEnableFTP;
        public byte byProtocolType;
        public int wFTPPort;
        public Server unionServer = new Server();
        public byte[] szUserName = new byte[32];
        public byte[] szPassWORD = new byte[16];
        public byte[] szTopCustomDir = new byte[64];
        public byte[] szSubCustomDir = new byte[64];
        ...
        public byte[] byRes2 = new byte[198];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byEnableFTP", "byProtocolType", "wFTPPort", "unionServer", "szUserName", "szPassWORD", "szTopCustomDir",
                    "szSubCustomDir", "byDirLevel", "byTopDirMode", "bySubDirMode", "byType", "byEnableAnony", "byAddresType", "byRes2");
        }
    }

    public static class FtpPara extends Structure {
        public NET_DVR_FTP_SERVER_TEST_PARA struFtpPara = new NET_DVR_FTP_SERVER_TEST_PARA();
        public byte[] byRes1 = new byte[212];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("struFtpPara", "byRes1");
        }
    }

    public static class Sender extends Structure {
    ...
    public static class Receiver extends Structure {
        public byte[] sName = new byte[32];
        public byte[] sAddress = new byte[48];
    ...
    public static class NET_DVR_EMAILCFG_V30 extends Structure {
        ...
        public NET_DVR_EMAILCFG_V30() {
            for (int i = 0; i < 3; i++) {
                struReceiver[i] = new Receiver();
            }
        }

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "sAccount", "sPassword", "struSender", "sSmtpServer", "sPop3Server", "struReceiver", "byAttachment",
                    "bySmtpServerVerify", "byMailInterval", "byEnableSSL", "wSmtpPort", "byEnableTLS", "byStartTLS", "byRes");
        }
    }

    public static class EmailPara extends Structure {
        public NET_DVR_EMAILCFG_V30 struEmailPara = new NET_DVR_EMAILCFG_V30();
        public byte[] byRes1 = new byte[80];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("struEmailPara", "byRes1");
        }
    }

    public static class IpPara extends Structure {
        public NET_DVR_IPADDR struIp = new NET_DVR_IPADDR();
        public byte[] byRes1 = new byte[716];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("struIp", "byRes1");
        }
    }
    ...
    public static class CloudStoragePara extends Structure {
        public NET_DVR_IPADDR struIPAdder = new NET_DVR_IPADDR();
        public short wPort;
        public byte[] byRes2 = new byte[2];
        public byte[] szUser = new byte[48];
        public byte[] szPassword = new byte[48];
        public NET_DVR_POOLPARAM[] struPoolInfo = new NET_DVR_POOLPARAM[16];
        public byte byProtocolType;
        public byte[] byRes3 = new byte[3];
        public byte[] szAccessKey = new byte[64];
        public byte[] szSecretKey = new byte[64];
        public byte[] byRes1 = new byte[354];

        public CloudStoragePara() {
            for (int i = 0; i < 16; i++) {
                struPoolInfo[i] = new NET_DVR_POOLPARAM();
            }
        }

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("struIPAdder", "wPort", "byRes2", "szUser", "szPassword", "struPoolInfo",
                    "byProtocolType", "byRes3", "szAccessKey", "szSecretKey", "byRes1");
        }
    }

    public static class PhoneNumPara extends Structure {
        public byte[] byPhoneNum = new byte[32];
        public byte[] byRes1 = new byte[708];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("byPhoneNum", "byRes1");
        }
    }
    ...
    public static class NtpPara extends Structure {
        NET_DVR_NTPPARA ntpPara = new NET_DVR_NTPPARA();
        public byte[] byRes1 = new byte[660];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ntpPara", "byRes1");
        }
    }

    public static class NasPara extends Structure {
        public NET_DVR_SINGLE_NET_DISK_INFO_V40 nasPara = new NET_DVR_SINGLE_NET_DISK_INFO_V40();
        public byte[] byRes1 = new byte[260];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("nasPara", "byRes1");
        }
    }

    public static class ServerPara extends Union {
        public byte[] byRes = new byte[740];
        //public NtpPara struNtpPara = new NtpPara();
        //public NasPara struNasPara = new NasPara();
        //public FtpPara struFtpPara = new FtpPara();
        //public EmailPara struEmailPara = new EmailPara();
        public IpPara struIpPara = new IpPara();
        //public CloudStoragePara struCloudStoragePara = new CloudStoragePara();
        //public PhoneNumPara struPhoneNumPara = new PhoneNumPara();
    }

    public static class NET_DVR_SERVER_TEST_PARA extends Structure {
        public int dwSize;
        public ServerPara unionServerPara = new ServerPara();
        public byte[] byRes2 = new byte[800];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "unionServerPara", "byRes2");
        }
    }

    public static class NET_DVR_MANUAL_CURRICULUM_CFG extends Structure {

        public int dwSize;
        public byte[] byRecUUID = new byte[64];
        public byte[] byCourseName = new byte[128];
        public byte[] byInstructorName = new byte[64];
        public byte[] byCourseDescription = new byte[256];
        /**
         * 命令，0-开始录像 1-结束 2-暂停 3-继续,4-开始屏蔽，5-结束屏蔽
         */
        public byte byCmdType;
        public byte[] byRes = new byte[303];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byRecUUID", "byCourseName",
                    "byInstructorName", "byCourseDescription", "byCmdType", "byRes");
        }
    }

    public static class NET_DVR_BACKGROUND_PIC_INFO extends Structure {
        public int dwSize;
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
        public byte[] byPicID = new byte[MAX_ID_LEN];
        public byte[] byRes = new byte[300];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byEnable", "byRes1", "byPicID", "byRes");
        }
    }

    public static class NET_DVR_BACKGROUND_PIC_CFG extends Structure {
        public byte dwSize;
        public byte dwPicSize;
        public byte dwPicType;
        public byte wPicWidth;
        public byte wPicHeight;
        public byte[] byPicName = new byte[128];
        public byte[] byRes = new byte[128];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "dwPicSize", "dwPicType",
                    "wPicWidth", "wPicHeight", "byRes", "byPicName");
        }
    }

    public static class NET_DVR_BACKGROUND_PIC_COND extends Structure {
        public int dwSize;
        public byte[] szFileID = new byte[MAX_ID_LEN];
        public byte[] byRes = new byte[256];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "szFileID", "byRes");
        }
    }
    ...
    boolean NET_DVR_SetLogToFile(int level, String str, boolean is);
    ...
    boolean NET_DVR_STDControl(int lUserID, int dwCommand, Pointer lpControlParam);
    ...
    boolean NET_DVR_GetRemoteConfigState(long lHandle, Pointer lpStatus);
    ...
    public static class NET_DVR_RECORD_STATUS extends Structure {
        public int dwSize;
        public byte[] byRecUUID = new byte[64];
        /**
         * 1.0-暂停中，1-屏蔽,2-正在录像中，3-空闲中
         */
        public byte byRecordStatus;
        public byte[] byRes1 = new byte[3];
        public int dwRecordingTime;
        public byte[] byRes = new byte[596];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "byRecUUID", "byRecordStatus", "byRes1", "dwRecordingTime", "byRes");
        }
    }

    public static final int NET_DVR_DEL_BV_CALIB_PIC = 4175;

    public static class NET_DVR_BV_HCORRECTION_COND extends Structure {
        public int dwSize;
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("dwSize", "dwChannel", "dwPicID", "byRes");
        }
    }


    int NET_DVR_RealPlay_V40(int var1, INTER_PREVIEWINFO var2, RealPlayCallBack var3, Surface var4);
    ...
    public interface RealPlayCallBack extends Callback {
    ...
    String NET_DVR_GetErrorMsg(INT_PTR var1);

    public static final int NET_DVR_SET_BACKGROUND_PIC_INFO = 6431;
    public static final int NET_DVR_GET_TERMINAL_CALL_CFG = 9144;
    public static final int NET_DVR_GET_TERMINAL_CONFERENCE_STATUS = 9136;
    public static final int MAX_URL_LEN = 512;
    //获取设备GK能力值
    public static final int NET_DVR_GET_TERMINAL_GK_CFG_CAP = 9153;
    public static final int NET_DVR_GET_VCS_CAP = 9152;
    public static final int NET_DVR_GET_TERMINAL_CTRL_CAP = 9146;
    public static final int NET_DVR_TERMINAL_CTRL = 9147;
    public static final int NET_DVR_GET_RECORD_HOST_CAP = 6433;

    public static class NET_DVR_TERMINAL_CONFERENCE_STATUS extends Structure {
        public int dwSize;
        /**
         * 会议类型：1- 点对点，2- MCU发起会议
         */
        public byte byConferenceState;
        /**
         * 会议状态：0- 空闲，1- 忙碌（会议中），2- 呼叫中，3- 被呼叫中
         **/
        public byte byConferenceType;
        public byte[] byRes1 = new byte[2];
        public int dwInputNo;
        /**
         * 会议信息
         */
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{
                    "dwSize", "byConferenceState", "byConferenceType"
                    , "byRes1", "dwInputNo", "struCallInfo",
                    "struAudioStatus", "byRes2"
            });
        }
    }

    public static class NET_DVR_CONFERENCE_CALL_INFO extends Structure {
        public byte[] byConferenceID = new byte[MAX_ID_LEN];
        public byte[] byConferenceName = new byte[NAME_LEN];
    ...
    public static class NET_DVR_CALL_INFO extends Union {
        public byte[] byRes = new byte[640];
        public NET_DVR_TERMINAL_CALL_INFO struTerminalCallInfo = new NET_DVR_TERMINAL_CALL_INFO();
        public NET_DVR_CONFERENCE_CALL_INFO struConferenceCallInfo = new NET_DVR_CONFERENCE_CALL_INFO();
    }

    public static class NET_DVR_TERMINAL_CALL_CFG extends Structure {
        public int dwSize;
        public byte byAnswerType;
        public byte byProtocolType;
        public byte byTransmissionProtocol;
        public byte[] byRes = new byte[39];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "byAnswerType", "byProtocolType", "byTransmissionProtocol", "byRes"});
        }
    }

    public static class NET_DVR_TERMINAL_CTRL_PARAM extends Structure {
        public int dwSize;
        /**
         * 1-接听，2-拒接，3-呼叫，4-音频调节，5-挂断，6-双流开，7-双流关
         */
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "byOperateType", "byRes1", "struCtrlParam", "byRes2"});
        }
    }

    public static class NET_DVR_TERMINAL_DETAIL_CTRL_PARAM extends Union {
        public byte[] byRes = new byte[640];
        //参照HCNetSDKByJna中的一些联合体的初始化方式
        public NET_DVR_TERMINAL_CALL_INFO struCallInfo;
        public NET_DVR_TERMINAL_AUDIO_CTRL struAudioCtrl;

    }

    public static class NET_DVR_HOWLING_SUPPRESSION extends Structure {
        public byte byEnabled;  //是否使能啸叫抑制
        public byte byHsSensibility;    //啸叫抑制灵敏度
        public byte byHsMode;   //啸叫抑制模式，0-默认，1-慢速，2-快速
        public byte byRes1;
        public int dwHsTime; //啸叫抑制时间，单位：ms
        public byte[] byRes2 = new byte[16];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"byEnabled", "byHsSensibility", "byHsMode", "byRes1", "dwHsTime", "byRes2"});
        }
    }

    public static class NET_DVR_TERMINAL_INPUT_AUDIO extends Structure {
        public int dwChannel; //通道号
        public byte byGainType; //增益类型，1-数字增益，2-模拟增益,3-两者
        public byte byEnableSimulate; //是否启用模拟增益，0-否，1-是
        public byte byVolumeSimulate;  //模拟音量，启用时有效，1-100
        public byte byEnableDigital; //是否启用数字增益，0-否，1-是
        public byte byVolumeDigital;  //数字音量，启用时有效，1-100
        public byte[] byRes1 = new byte[3];
        public NET_DVR_HOWLING_SUPPRESSION struHsParam;    //啸叫抑制参数
        public byte[] byRes = new byte[604];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwChannel", "byGainType", "byEnableSimulate",
                    "byVolumeSimulate", "byEnableDigital", "byVolumeDigital", "byRes1"
                    , "struHsParam", "byRes"});
        }
    }

    public static class NET_DVR_TERMINAL_AUDIO_CTRL extends Structure {
        public byte byMute;
        public byte byVolume;
        public byte byAudioInputDisabled;
        public byte byAudioInputVolume;
        public byte[] byRes = new byte[636];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"byMute", "byVolume", "byAudioInputDisabled", "byAudioInputVolume", "byRes"});
        }
    }

    public static class NET_DVR_TERMINAL_CALL_INFO extends Structure {
        public byte[] byTermianlURL = new byte[MAX_URL_LEN];
        public int dwCallRate;
        public byte[] byRes = new byte[124];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"byTermianlURL", "dwCallRate", "byRes"});
        }
    }

    public static class NET_DVR_AUDIO_STATUS extends Structure {
        public byte byMute;
        public byte byVolume;
        public byte byAudioInputDisabled;
        public byte byAudioInputVolume;
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{
                    "byMute", "byVolume", "byAudioInputDisabled"
                    , "byAudioInputVolume", "byRes"
            });
        }
    }

    public static final int NET_DVR_GET_TERMINAL_INPUT_CFG = 9138;

    public static class NET_DVR_TERMINAL_INPUT_CFG extends Structure {
        public int dwSize;
        public int dwInputNo;
        public byte byStreamType;
        public byte[] byRes = new byte[31];
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "dwInputNo", "byStreamType", "byRes"});
        }
    }

    public static class NET_DVR_RTMP_COND extends Structure {
        public int dwSize;
        public int dwChannel;
        public byte byStreamType;
        public byte[] byRes = new byte[303];
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "dwChannel", "byStreamType", "byRes"});
        }
    }

    public static class NET_DVR_COURSE_LIST_COND extends Structure {
        public int dwSize;
        public NET_DVR_TIME struStartTime;
        public NET_DVR_TIME struEndTime;
        public byte[] byCourseName = new byte[128];
        ...
        public byte[] byRes = new byte[603];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "struStartTime", "struEndTime"
                    , "byCourseName", "byInstructorName", "byCourseType", "byRes"});
        }
    }

    public static class NET_DVR_COURSE_CFG extends Structure {
        public int dwSize;
        public NET_DVR_TIME struStartTime;
        public NET_DVR_TIME struEndTime;
        public byte[] byCourseName = new byte[128];
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "struStartTime", "struEndTime"
                    , "byCourseName", "byInstructorName", "byCourseDescription", "byRecUUID", "byCourseType", "byRes"});
        }

    }

    public static class NET_DVR_RTMP_CFG extends Structure {
        public int dwSize;
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList(new String[]{"dwSize", "byEnable", "byRes1", "dwPacketLen", "szURL", "byRes"});
        }
    }
}